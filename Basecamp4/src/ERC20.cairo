...
mod tests{
    ...
    fn test_01_constructor(){
        ...
        assert(res_total_supply == initial_supply, 'total_supply does not match.');

        let res_init_supply = ERC20::balance_of(account);
        assert(res_init_supply == initial_supply, 'initial_supply does not match.');
        // Test decimals
        // Your code here
